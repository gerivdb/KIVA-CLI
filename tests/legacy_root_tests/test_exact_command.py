...
# This is the exact command from the pipeline YAML for verify-registry-sync
command = '''python -c "
import json, sys, os
...
env = {**os.environ, 'ECOS_ROOT': 'D:/DO/WEB/TOOLS/ECOS_ROOT.json', 'TOPOS_REGISTRY': 'D:/DO/WEB/TOOLS/L1-INFRA/TOPOS/registry/repos.json', 'KNOWN_REPOS': 'D:/DO/WEB/TOOLS/L0-CANON/GOVERNANCE-HUB/known_repositories.yaml', 'OUTPUT_DIR': 'D:/DO/WEB/TOOLS/reports/ecosystem-orchestration'}
